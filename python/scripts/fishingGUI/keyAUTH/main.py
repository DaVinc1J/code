...
keyauthapp = api(
    name = "Scripts", # Application Name
    ownerid = "SZNxnyZwpd", # Owner ID
    secret = "73be4da7d43e1d0e4e1dce6bf324fcf7588e87a98e714aacb49b9f95c00776e0", # Application Secret
...
subprocess.Popen(["start", "cmd", "/k", sys.executable, "FishingGUI.py"], shell=True)
